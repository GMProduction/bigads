...
{{--            <img src="../assets/img/brand/blue.png" class="navbar-brand-img" alt="...">--}}
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" id="dashboard" href="/mitra/">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="iklan" href="/mitra/iklan">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="transaksi" href="/mitra/transaksi">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profil" href="/mitra/profil">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml--2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 text-sm">Hi, {{auth()->user()->nama}}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                  ...
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="{{asset('assets/img/theme/team-4.png')}}">
                                ...
                                <div class="media-body  ml-2  d-none d-lg-block">
                                    <span class="mb-0 text-sm  font-weight-bold">Hi, {{auth()->user()->nama}}</span>
                                </div>
                            </div>
                        </a>
